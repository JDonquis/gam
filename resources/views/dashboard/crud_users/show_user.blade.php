                ...
                <div class="h-full bg-gray-200 p-8">
                    <div class="bg-white rounded-lg shadow-xl pb-8">
                        ...
                        <div class="flex flex-col items-center -mt-20">
                            <img src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('assets/img/default.png') }}" class="w-40 border-4 border-white rounded-full">
                        ...
                        <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                            <div class="flex items-center space-x-4 mt-2">
                                <a href="{{route('users.edit',['user' => $user->id])}}" class="flex items-center bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                                ...
                                <form method="POST" action="{{ route('users.destroy',['user' => $user->id]) }}"
                                    x-data="{ confirmDelete() { return confirm('¿Estás seguro de eliminar esta cuenta? Esta acción es irreversible.') } }"
    ...
    <div class="w-full 2xl:w-1/2 bg-white rounded-lg shadow-xl p-8 h-fit">
        ...
        <ul class="mt-2 text-gray-700">
            <li class="flex border-y py-2 ">
                ...
                <span class="text-gray-700 px-2">{{$user->fullname}}</span>
            </li>
            <li class="flex border-y py-2 ">
                <span class="font-bold w-fit">Cédula:</span>
                <span class="text-gray-700 px-2">{{$user->ci}}</span>
            </li>
            ...
            <li class="flex border-b py-2">
                ...
                <span class="text-gray-700 px-2">{{ $user->phone_number }}</span>
            </li>
        </ul>
    </div>

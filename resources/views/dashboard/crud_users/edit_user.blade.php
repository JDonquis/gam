        ...
        <div class="w-full">
            ...
            <div class="mt-6">
                ...
                <form action="{{route('users.update',['user' => $user->id])}}" method="POST" enctype="multipart/form-data" x-data="{
                    ...
                    photoPreview: '{{ $user->photo ? asset('storage/'.$user->photo) : asset('assets/img/default.png') }}',
                    ...
                    <div class="flex gap-2 mt-6">
                        <a href="{{route('users.show',['user' => $user->id])}}" type="button" class="bg-secondary bg-opacity-20 hover:bg-opacity-40 rounded-lg px-6 py-1.5 text-secondary hover:shadow-xl transition duration-150">Cancelar</a>
